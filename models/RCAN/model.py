...
class RCAN(nn.Module):
		def __init__(self, channels, scale_factor, conv=common.default_conv):
				...
				# rgb_std = (1.0, 1.0, 1.0)						# DIV2K
				rgb_mean = (0.09605248, 0.08241889, 0.09570218, 0.09395839, 0.09162653, 0.09839191,
				...
				self.sub_mean = common.MeanShift(channels, rgb_range, rgb_mean, rgb_std)
				...
				self.add_mean = common.MeanShift(channels, rgb_range, rgb_mean, rgb_std, 1)
