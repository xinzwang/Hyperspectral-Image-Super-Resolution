...
class SSPSR(nn.Module):
		# def __init__(self, channels, scale_factor, n_subs=8, n_ovls=2, n_blocks=3, n_feats=256, res_scale=0.1, use_share=True, conv=default_conv):
		def __init__(self, channels, scale_factor, n_subs=4, n_ovls=1, n_blocks=3, n_feats=256, res_scale=0.1, use_share=True, conv=default_conv):	# CAVE
